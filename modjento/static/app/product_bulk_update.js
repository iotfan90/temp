angular.module('modjento').controller('ProductBulkUpdateController', [ '$scope', '$http', function ($scope, $http) {
    ...
    $scope.non_processed_products = [];
    $scope.processed_product_counter = 0;
