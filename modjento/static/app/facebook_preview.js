angular.module('modjento').controller('FacebookPreviewController', [ '$scope', '$http', '$timeout', function ($scope, $http, $timeout) {
    ...
    $scope.success = null;
    $scope.message = null;
    console.log(window.modjento_data.ad_message);
    $scope.adData = {
        ...
        is_active: false,
        bmc_url: window.modjento_data.bmcUrl,
        ...
        category_id: window.modjento_data.categoryId,
    };
    ...
    $scope.updateBmc = function() {
        $scope.adData.bmc_url = updateTracking(window.modjento_data.bmcUrl, $scope.adData.name);
    };
